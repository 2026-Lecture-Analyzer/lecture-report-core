...
def _chunked(texts: Iterable[str], max_chars: int = 50_000):
...
def noun_counts(texts: Iterable[str], min_len: int = 2) -> Counter:
...
def filler_counts(texts: Iterable[str]) -> Counter:
